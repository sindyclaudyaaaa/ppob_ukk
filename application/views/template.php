				...
				<nav>
					<ul class="nav">
						<?php
							...
							?>
								<li>
									<a href="<?=base_url('index.php');?>/dashboard" ><i class="lnr lnr-home"></i> <span>Dashboard</span></a>
								</li>

								<li>
									<a href="<?=base_url('index.php');?>/masakan" ><i class="lnr lnr-code"></i> <span>Masakan</span></a>
								</li>

								<li>
									<a href="<?=base_url('index.php');?>/pelanggan/list_pelanggan" ><i class="lnr lnr-code"></i> <span>Pelanggan</span></a>
								</li>
								<li>
									<a href="<?=base_url('index.php');?>/transaksi" ><i class="lnr lnr-code"></i> <span>Transaksi</span></a>
								</li>

								<?php if ($this->session->userdata('level_name') == 'admin'): ?>
									<li>
										<a href="<?=base_url('index.php');?>/admin" ><i class="lnr lnr-code"></i> <span>Admin</span></a>
									</li>
								<?php endif ?>
							<?php
